  ...
  return (
    <section className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 sm:px-6 lg:flex-row lg:items-center lg:gap-16 lg:px-12">
      <div className="flex-1 space-y-6">
        ...
        <h1 className="text-4xl font-semibold leading-tight text-slate-900 sm:text-5xl" data-i18n="show_world">
          Show the world that you mean business.
        </h1>
        <p className="text-lg text-slate-600" data-i18n="congratulations">
        ...
        <div className="flex flex-wrap gap-3">
          <ButtonWithModal className="inline-flex items-center rounded-lg bg-metaBlue px-6 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-metaIndigo" data-i18n="subscribe_on_facebook">
